...
D'autres espèces sont positivement corrélées sur cet même axe avec E34, E55 et un paquet regroupant E57, E21, E44 et E46.
...
Pour cela, nous avons tout d'abord vérifier qu'aucune autocorrélation spatiales n'entrait en jeu (Mansel test) ce qui était cependant le cas.

Nous avons donc dû nous tourner est une Analyse Partielle Canonique des Correspondances (pCCA) qui prend en compte la dépendance spatiale lors d'une analyse multivariée avec *a priori.* Pour cette analyse, nous avions trois tables comprenant l'abondance des espèces par site, les valeurs pédologiques par site, et les coordonnées géographiques des sites.
