...
La plaine du Mafragh est une entité géomorphologique au sud de la Mer Médirranée couvrant 15000 ha.
La zone d'étude est répartie sur 10000ha de cette plaine.
Des relevés pédologiques et d'abondance phytosociologiques ont été réalisé sur 97 sites.
Les coordonnées GPS de chaque site sont connues.
On se demande quelle sont les variables pédologiques qui structurent les communités végétales de la plaine du Mafragh.
...
Ainsi, les variables infulant sur la distribution des espèces floristique sont l'altitude et la capacité de rétention en eau mais également la concentration en ions K+ et Mg++.
Ces quatre variables n'étant corrélées à aucune autre, nous pouvons conclure qu'elles sont seules responsable de la répartition floristique.
