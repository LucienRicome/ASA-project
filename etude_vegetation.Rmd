...
Le graphique permet d'observer la répartition des points et aucune configuration régulière ne se détache (ex : rook, queen, etc.)
...
(B)
Celui-ci a une accuracy de 0.54, il prédit donc correctement une fois sur deux.