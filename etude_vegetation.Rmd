...
selected=as.data.frame(scale(mil2, center=TRUE, scale=TRUE))
...
Les données pédologiques expliquent 10% de la variance de la distribution floristique.
6% de cette variance sont expliqués par les coordonnées géographique.
...
L'inertie totale du tableau de comptage floristique s'élève à 8.3.
9% de cette inertie est expliquée par les coordonnées géographiques et 9% par les données pédologiques du milieu.
